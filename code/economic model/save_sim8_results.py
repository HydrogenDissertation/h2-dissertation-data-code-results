import pandas as pd
from sim8_SellingH2 import results_simulation
...
df_summary.to_excel("sim8_results.xlsx", sheet_name="Results", index=False)
print("\nResultados guardados em 'sim8_results.xlsx'")
