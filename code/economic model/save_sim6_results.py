import pandas as pd
from sim6_H2orImport import results_simulation  
...
df_summary.to_excel("sim6_results.xlsx", sheet_name="Results", index=False)
print("\nResultados guardados em 'sim6_results.xlsx'")
